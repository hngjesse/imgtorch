...
class ImgTorch:
    ...
    def __init__(self, baseDir, classDir, nonRawSpecialExt=[]):
        """
...
### Group the files by class and create a new folder structure for each class. ###
### Pick up the important images based on filename patterns. ###
